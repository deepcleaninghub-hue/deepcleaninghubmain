export const fr = {
  ...
  services: {
    ...
    distancePlaceholder: 'Entrez la distance en kilomètres',
    boxesLabel: 'Nombre de Boîtes',
    ...
    distanceInput: 'Entrée de Distance',
    enterDistance: 'Entrez la distance en kilomètres',
    distanceHint: 'Distance du point de ramassage à la destination',
    boxesInput: 'Nombre de Boîtes',
    optional: 'Optionnel',
    enterNumberOfBoxes: 'Entrez le nombre de boîtes (optionnel)',
    boxesHint: 'Boîtes supplémentaires pour articles fragiles',
    ...
    calculationSubtotal: 'Sous-total: €{{areaCost}} + €{{distanceCost}}{{boxesText}} = €{{subtotal}}',
    calculationVat: 'TVA (19%): €{{vat}}',
