export const ru = {
  ...
  home: {
    ...
    subtitle: 'Ваш надежный партнер в области профессиональных услуг по уборке',
    placeholder: 'Это ваш главный экран. Содержимое будет добавлено сюда в ближайшее время.',
  ...
  cart: {
    ...
    continue: 'Продолжить',
    failedToAdd: 'Ошибка добавления в корзину',
  ...
  services: {
    ...
    furnitureDisassembly: 'Разборка мебели',
    ...
    order: 'Заказать',
    couldNotOpenPhoneApp: 'Не удалось открыть приложение телефона',
    unableToOpenWhatsApp: 'Не удалось открыть WhatsApp',
    whatsappMessage: 'Привет! Я хотел бы узнать о ваших услугах по уборке.',
    browseServices: 'Просмотреть услуги',
    ...
    distancePlaceholder: 'Введите расстояние в километрах',
    boxesLabel: 'Количество коробок',
    boxesPlaceholder: 'Введите количество коробок (необязательно)',
    distanceHint: 'Расстояние от точки забора до места назначения',
    boxesInput: 'Количество коробок',
    optional: 'Необязательно',
    enterNumberOfBoxes: 'Введите количество коробок (необязательно)',
    boxesHint: 'Дополнительные коробки для хрупких предметов',
