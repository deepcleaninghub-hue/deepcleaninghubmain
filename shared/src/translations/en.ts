export const en = {
  ...
  orders: {
    ...
    singleDateService: 'Single date service (date will be selected at checkout)',
  ...
  checkout: {
    ...
    multiDayService: 'Multi-day Service',
    singleDateService: 'Single date service (date will be selected at checkout)',
    singleDayService: 'Single day service',
    serviceAddress: 'Service Address',
  ...
  services: {
    ...
    distanceHint: 'Enter the distance for the moving service',
    boxesInput: 'Number of Boxes',
    enterNumberOfBoxes: 'Enter number of boxes',
    boxesHint: 'Moving boxes (65×35×37 cm) - €2.50 each',
    boxes: 'Boxes',
    optional: 'Optional',
